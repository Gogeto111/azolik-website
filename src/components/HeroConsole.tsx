...
const SCENARIOS = [
  {
    department: 'Support',
    color: '#4fd1c5',
    customer: 'Do you have blue Nike shoes in size 9?',
    tasks: [
      'Searching inventory database...',
      'Nike Air Max 90 · Blue · Size 9 · 3 in stock',
      'Drafting reply in your brand voice',
      'CRM updated · Ticket #2847 resolved',
    ],
    response:
      "Great news! We have the Nike Air Max 90 in blue, size 9 — 3 left in stock. Want me to reserve one for you?",
    time: '2.4s',
    count: 4,
  },
  {
    department: 'Sales',
    color: '#a78bfa',
    customer: 'New lead: Sarah Johnson · TechCorp · $50k budget · High intent',
    tasks: [
      'Researching TechCorp · $12M ARR · Series B · 180 employees',
      'Lead scored 94/100 · Buying signals detected on pricing page',
      'Personalised email drafted referencing APAC expansion',
      'Follow-up sequence created · Days 3 and 7',
    ],
    response:
      "Hi Sarah — I saw TechCorp is expanding into APAC. We've helped three similar firms automate that transition in under a week...",
    time: '3.1s',
    count: 4,
  },
  {
    department: 'Finance',
    color: '#34d399',
    customer: 'New payment: $2,847.00 received from Meridian Studio · Stripe',
    tasks: [
      'Matched to INV-2024-089 · 3 days overdue · Cleared',
      'Categorised: Revenue · Q4 SaaS subscription',
      'Cash position updated · Runway extended to 14 months',
      'P&L refreshed · Revenue up 14% month-over-month',
    ],
    response:
      "Payment reconciled. INV-2024-089 marked paid. Cash runway extended to 14 months. P&L report ready for your review.",
    time: '1.8s',
    count: 4,
  },
]

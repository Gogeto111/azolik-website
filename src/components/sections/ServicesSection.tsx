...
function ServiceCard({ service }: { service: typeof SERVICES[0] }) {
  ...
  return (
    <div
      ref={ref}
      className="relative rounded-2xl p-8 group holo-card card-glow cursor-pointer"
      style={{
    ...
    <section ref={ref} id="services" className="reveal relative z-10 py-32 px-6" style={{ background: '#08090c' }}>
      <div className="max-w-7xl mx-auto">
        <div className="text-center max-w-3xl mx-auto mb-20">
          ...
          <h2 className="font-bold text-white mb-6" style={{ fontFamily: "'Outfit', sans-serif", fontSize: 'clamp(32px, 5vw, 56px)' }}>

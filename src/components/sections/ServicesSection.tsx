    ...
    >
      ...
      <div className="relative z-10">
        ...
        <div className="mt-6 pt-6 border-t border-white/5 flex items-center justify-between">
          <span
            className="text-white/30 text-sm uppercase tracking-wide"
...
export function ServicesSection() {
  ...
  return (
    <section
      ref={ref}
      id="services"
      className="reveal relative z-10 py-32 px-6"
        ...
        <div className="text-center max-w-3xl mx-auto mb-20">
          <div className="flex items-center justify-center gap-2 mb-6">
            ...
            <p
              ...
              style={{ fontFamily: "'JetBrains Mono', monospace", color: 'rgba(167,139,250,0.9)' }}
            >
              What We Do
            </p>
            <span
              className="w-8 h-px"
              style={{ background: 'linear-gradient(to left, transparent, #a78bfa)' }}
            />
          </div>
          <h2
          ...
          >
            We design AI-powered systems that{' '}
            <span className="gradient-text">replace manual labor</span>, streamline operations, and
            scale your business — without the burnout.
          </h2>
          <p className="text-white/35 text-lg leading-[1.65] max-w-2xl mx-auto">
            Whether you're looking to automate outreach, run AI voice agents, or create ad content
            that converts, our solutions are built to give you leverage and results from day one.
          </p>
        </div>

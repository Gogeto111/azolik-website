...
function TestimonialCard({ testimonial, index }: { testimonial: typeof TESTIMONIALS[0]; index: number }) {
  ...
  return (
    <div
      ...
      className="relative rounded-2xl p-7 transition-all duration-300 group flex flex-col holo-card entrance-fade-up"
      style={{
  ...
  return (
    <section ref={ref} id="testimonials" className="reveal relative z-10 py-32 px-6">
      <div className="max-w-7xl mx-auto">
        ...
        <div ref={grid} className="reveal-stagger relative max-w-6xl mx-auto grid md:grid-cols-2 lg:grid-cols-4 gap-5">

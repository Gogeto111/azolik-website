      ...
      <div data-orb className="absolute will-change-transform" style={{ left: '5%', top: '-60px' }}>
        <div
          ...
          style={{
            ...
            background:
              'radial-gradient(circle at 30% 30%, rgba(124,58,237,0.12), rgba(124,58,237,0.03))',
      ...
      <div data-orb className="absolute will-change-transform" style={{ left: '8%', top: '-20px' }}>
        <div
          ...
          style={{
            ...
            background:
              'radial-gradient(circle at 40% 40%, rgba(79,209,197,0.1), rgba(79,209,197,0.02))',
      ...
      >
        <div
          ...
          style={{
            ...
            background:
              'radial-gradient(circle at 60% 40%, rgba(251,146,60,0.1), rgba(251,146,60,0.02))',
